...
<h2>Be one of the team!</h2>
    ...
    <div class="form-background">
        ...
        <form style= "padding-bottom: 50px">
            ...
            <div class="form-group d-flex justify-content-between mb-3">
            <label for="exampleFormControlSelect1" class="w-25 font-weight-bold form-control-lg">Position</label>
            <select class="form-control " id="exampleFormControlSelect1">
                <option>Catering</option>
                <option>Pubpro</option>
                <option>PrepTech</option>
                <option>SpecTa</option>
