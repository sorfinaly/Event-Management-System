...
<h2>List Of Participants</h2>
    ...
    <div class="form-background">
        ...
        <table class="table table-striped table-dark">
            ...
            <tbody>
                @foreach ($feeparticipants as $feeparticipant)
                    <tr>
                        <td>{{ $feeparticipant->matric_id }}</td>
                        <td>{{ $feeparticipant->full_name }}</td>
        ...
        <div class="d-flex justify-content-between align-items-center pb-4">
            ...
            <button onclick="window.location.href='/formparticipantfee'" class="btn btn-lg d-flex align-items-center" style="background-color: #2A6562; color: white;">
