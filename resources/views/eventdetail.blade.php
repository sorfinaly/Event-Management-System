        ...
        @php
            ...
            <div class="d-flex justify-content-between align-items-center pb-4">
                ...
                <div class="d-flex justify-content-center align-items-center pb-4">
                    ...
                    @csrf
                    @method('DELETE')
                    <button onclick="return confirm('Are you sure you want to delete this event?')" type="submit" id="submit" class="btn btn-lg d-flex align-items-center" style="background-color: #2A6562; color: white;">Delete Event</button>
