            ...
            <div class="d-flex justify-content-between align-items-center pb-4">
                ...
                <div class="d-flex justify-content-center align-items-center pb-4" style="margin-top:25px">
                    <form action="{{ route('events.destroy', $event->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
                        <button onclick="return confirm('Are you sure you want to delete this event?')" type="submit" id="submit" class="btn btn-lg d-flex align-items-center" style="background-color: #cc0000; color: white;">
                            Delete Event
                        </button>
                    </form>
                </div>
